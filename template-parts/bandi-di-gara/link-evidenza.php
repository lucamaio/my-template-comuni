<?php
$link_evidenza = dci_get_option('bdncp_link_evidenza', 'trasparenza', array());
...
<section class="dci-bdncp-link-evidenza mb-4" aria-labelledby="dci-bdncp-link-evidenza-title">
    <h3 id="dci-bdncp-link-evidenza-title" class="h4 mb-3">
        <?php esc_html_e('Collegamenti in evidenza', 'design_comuni_italia'); ?>
    </h3>

    <div class="dci-bdncp-link-evidenza__list">
        <?php foreach ($link_evidenza as $link) :
            ...
            ?>
            <article class="card dci-bdncp-link-evidenza__card t-primary">
                <div class="card-body position-relative">
                    <div class="dci-bdncp-link-evidenza__icon" aria-hidden="true">
...
<style>
    .dci-bdncp-link-evidenza__list {
        display: flex;
        flex-direction: column;
        gap: 1.25rem;
    }
    .dci-bdncp-link-evidenza__card {
        width: 100%;
    ...
    .dci-bdncp-link-evidenza__card:hover {
        border-color: #c9d7e5 !important;
        box-shadow: 0 12px 28px rgba(23, 50, 77, .11) !important;
        transform: translateY(-1px);
    }
    .dci-bdncp-link-evidenza__card .card-body { padding: 1.35rem; }
    .dci-bdncp-link-evidenza__card a { color: currentColor; }
    .dci-bdncp-link-evidenza__icon {
        position: absolute;
        top: 1.1rem;
        right: 1.1rem;
        display: inline-flex;
    ...
    .dci-bdncp-link-evidenza__icon .icon { fill: currentColor; }
</style>
