...
global $the_query, $load_posts, $load_card_type;
    ...
    usort($posts, function($a, $b) {
        return dci_get_data_pubblicazione_ts("data_pubblicazione", '_dci_progetto_', $b->ID) - dci_get_data_pubblicazione_ts("data_pubblicazione", '_dci_progetto_', $a->ID);
    });
                ...
                <div class="cmp-input-search">
                    <div class="form-group autocomplete-wrapper mb-0">
                        ...
                        <p id="autocomplete-label" class="u-grey-light text-paragraph-card mt-2 mb-30 mt-lg-3 mb-lg-40">
                            <?php echo $the_query->found_posts; ?> progetti trovati in ordine alfabetico
                        </p>
                    </div>
                </div>
            </div>
