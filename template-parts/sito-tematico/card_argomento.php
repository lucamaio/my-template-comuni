   ...
   rel="noopener">
    ...
    <div class="card-body"
        ...
        <div style="display:flex;align-items:center;margin-bottom:5px;">
            ...
            <h3 class="card-title sito-tematico titolo-sito-tematico <?= $sfondo_scuro ? 'text-black' : 'text-dark' ?>"
                style="font-size:1.1rem;
                       font-weight:600;
                       color:<?= $sfondo_scuro ? '#333' : '#000' ?>;
                       margin-bottom:0;">

                <?php echo esc_html($sito_tematico->post_title); ?>
        ...
        <p class="card-text text-sans-serif <?= $sfondo_scuro ? 'text-black' : '' ?>"
           style="color:<?= $sfondo_scuro ? '#333' : '#555' ?>;
                  font-size:0.85rem;
                  margin-bottom:0;">

            <?php echo esc_html($st_descrizione); ?>
