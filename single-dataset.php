...
?>
    ...
    <main>
        ...
        while ( have_posts() ) :
            ...
            $data_protocollo = date('m/d/Y', dci_get_meta("data_modifica", $prefix, $post->ID));
            $tipo_documento = wp_get_post_terms( $post->ID, array( 'tipi_documento', 'tipi_doc_albo_pretorio' ) );
            $descrizione_breve = dci_get_meta("descrizione_breve", $prefix, $post->ID);
            $url_documento = dci_get_meta("dataset_url", $prefix, $post->ID);
            $ufficio_responsabile = dci_get_meta("titolare", $prefix, $post->ID);
                    ...
                    <article id="documenti" class="it-page-section anchor-offset mt-5">
                        ...
                        <div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
                            ...
                            <div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
                                ...
                                <div class="card-body">
                                <h5 class="card-title">
                                    <a class="text-decoration-none" href="<?php echo $file_documento; ?>" aria-label="Visualizza il documento <?php echo $documento->post_title; ?>" title="Scarica il documento <?php echo $documento->post_title; ?>">
