...
function createMenu()
{
    ...
    dci_create_page_menu_item(__( 'Segnalazione disservizio', 'design_comuni_italia'), $menu_info_1, __( 'Segnalazione disservizio', 'design_comuni_italia'));
    ...
    dci_create_custom_menu_item(__( 'Piano di miglioramento del sito', 'design_comuni_italia'),$menu_info_2, '/piano-di-miglioramento-del-sito');
    //assegno menu a location
