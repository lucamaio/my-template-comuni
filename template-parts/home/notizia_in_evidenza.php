                    ...
                    <div class="col-12 col-lg-6 order-2 order-lg-1 d-flex align-items-center">
                        <div class="card-body">
                            ...
                            <div class="category-top d-flex align-items-center mb-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 18 18" class="icon icon-md me-2" style="width:18px !important;height:18px !important;" aria-hidden="true">
