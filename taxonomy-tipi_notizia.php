...
<main>
	...
	<div class="container" id="custom-section">
		<div class="row justify-content-start row-shadow">
			<div class="col-12 col-lg-10 custom-content-wrapper">
				<div class="cmp-hero">
					<section class="it-hero-wrapper bg-white align-items-start">
						<div class="it-hero-text-wrapper pt-0 ps-0 pb-4 pb-lg-60">
							<h1 class="text-black hero-title" data-element="page-name"><?php echo single_term_title( '', false ); ?></h1>
